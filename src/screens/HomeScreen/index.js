...
import { FlatList, View, Text, Alert, Image, TouchableHighlight, AsyncStorage } from 'react-native';
...
// class HomeScreen extends React.Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      databanner: [
        {
          picture: "verifikasi",
          title: "Verifikasi Nomor Kamu"
        },
        {
          picture: "lengkapi_biodata",
          title: "Lengkapi Biodata Kamu"
        },
        {
          picture: "scan_ktp",
          title: "Upload KTP dan Foto Diri Kamu"
        },
        {
          picture: "scoring",
        ...
        {
          picture: "saldo",
          title: "Dana Akan di Cairkan di Akun Davestpay Anda"
        }
      ]
    }
    this.start()
  ...
  form_databanner(item)
  {
    return(
        <Lottie source={lengkapi_biodata} autoPlay loop />
    )
  }
  form_dua()
  {
    return (
      <View style={{ width: '100%', height: '100%', backgroundColor: "white" }}>
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            <View>
            <Lottie source={lengkapi_biodata} autoPlay loop style={{width: "48%", height: "80%", alignSelf: "center"}}/>
            </View>
          )}
        />
      </View>
