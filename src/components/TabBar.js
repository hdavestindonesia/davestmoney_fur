...
export default ({rightColor='red',leftColor='blue',change,add}) => (
	<View>
		<TouchableOpacity activeOpacity={1.0} style={styles.containerAddNew} onPress={(event)=>{
			...
			<View style={styles.halfRound}>
				<View style={centering}>
					<Image style={styles.addIcon} source={require('../assets/arrowright.png')} />
				 </View>
		...
		<View shadowRadius={25} shadowOffset={{height: 20}} shadowColor='black' shadowOpacity={1} style={styles.containerBetweenAddNew}>
			<Tab text="Accounts" textStyle={styles.assetsText} iconStyle={styles.assetsIcon} color={leftColor} source='list' />
			<Tab text="Settings" textStyle={styles.groupsText} iconStyle={styles.groupsIcon} color={rightColor} source='processing' />
		</View>
	</View>
)
...
let Tab = ({text,iconStyle,textStyle,color,source}) => (
	<View style={styles.between}>
		<Image style={[iconStyle,{tintColor:color}]} source={require('../assets/arrowright.png')} />
